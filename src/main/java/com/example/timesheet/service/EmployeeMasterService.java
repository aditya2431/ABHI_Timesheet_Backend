...
public class EmployeeMasterService {
	...
	public List<ManagerDashboardResponse> fetchManagerWiseTimesheetData(String manager,String fromDate,String toDate) {
		System.out.println("Inside EmployeeMasterService class fetchManagerWiseTimesheetData() method");
		List<Object[]> result = null;
	 ...
	 public List<UserDashboardResponse> fetchUserDashboard(String name) {
	        System.out.println("Inside YourServiceClassName class fetchUserDashboard() method");
	        List<Object[]> result = null;
	        ...
	        try {
	            ...
	            System.out.println("Error occurred while fetching dashboard timesheet data");
	            System.out.println(e.getMessage());
	        }
	 ...
	 public List<GetTimeResponse> getTotalTime(String name) {
	        System.out.println("Inside YourServiceClassName class getTotalTime() method");
	        List<Object[]> result = null;
